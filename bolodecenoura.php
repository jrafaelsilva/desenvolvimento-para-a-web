...
<body>
  ...
  <nav aria-label="breadcrumb" class="ms-3 mt-4">
    ...
    <div class="container">
      ...
      <img src="imgs/bolodecenoura.png" class="d-flex mx-auto w-50 border border-4 rounded">
        <div class="text-center my-4">
          ...
          <div class="d-flex justify-content-center gap-3">
            ...
            <button id="pauseBtn" class="btn btn-warning px-4" disabled>Pausar</button>
            <button id="resetBtn" class="btn btn-danger px-4" disabled>Recomeçar</button>
          </div>
        </div>
  ...
  <script>
  // --- VARIÁVEIS GLOBAIS ---
  let tempoRestante = 35 * 60; // 35 minutos em segundos
  let cronometro = null;
  let aDecorrer = false;
  ...
  // --- FUNÇÃO PARA INICIAR O CRONÓMETRO ---
